...
const AboutFeature = () => {
  return (
    <div className="w-full max-w-7xl mx-auto px-4 my-6">
      {}
      <div className="w-full bg-[#0a0d14]/90 backdrop-blur-md border border-white/10 rounded-2xl p-4 sm:p-8 shadow-2xl">
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-0">
          {featuresData.map((item, index) => {
            ...
            return (
              <div
                key={item.id}
                className={`flex items-center gap-4 p-3 sm:p-4 rounded-xl transition-all duration-300 group hover:bg-white/[0.02] ${
